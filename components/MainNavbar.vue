    ...
    <div class="navbar bg-base-100">
      ...
      <div class="navbar-end">
        <label class="swap swap-rotate">
          ...
          <!-- sun icon -->
          <svg class="w-8 h-8 mx-4 fill-current swap-on" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
          ...
          <!-- moon icon -->
          <svg class="w-8 h-8 mx-4 fill-current swap-off" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
