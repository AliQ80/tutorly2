...
export default {
  ...
  'family:text': {
    ...
    input: 'w-full px-3 py-2 border-none text-base text-blue-400 placeholder-gray-700',
  },
  'family:date': {
    inner: 'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
  ...
  'select': {
    ...
    input: 'w-full pl-3 pr-8 py-2 border-none text-base text-blue-400 placeholder-gray-600 formkit-multiple:p-0 data-[placeholder="true"]:text-gray-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
